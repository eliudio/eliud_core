...
class PublicMediumCache implements PublicMediumRepository {
  ...
  final Map<String?, PublicMediumModel?> fullCache = {};
  ...
  /// Add a PublicMediumEntity to the repository, cached
  @override
  ...
  /// Update a PublicMediumEntity in the repository, cached
  @override
  ...
  /// Delete a PublicMediumModel from the repository, cached
  @override
  ...
  /// Retrieve a PublicMediumModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<PublicMediumModel?>
  @override
  ...
  @override
  StreamSubscription<List<PublicMediumModel?>> listen(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  @override
  StreamSubscription<List<PublicMediumModel?>> listenWithDetails(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  static Future<PublicMediumModel> refreshRelations(
      PublicMediumModel model) async {
