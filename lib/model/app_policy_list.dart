...
typedef AppPolicyWidgetProvider = Function(AppPolicyModel? value);

class AppPolicyListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final AppPolicyWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final AppPolicyListWidgetState? state;
  ...
  AppPolicyListWidgetState createState() {
    return AppPolicyListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = AppPolicyListWidgetState();
