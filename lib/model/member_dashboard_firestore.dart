...
class MemberDashboardFirestore implements MemberDashboardRepository {
  ...
  MemberDashboardModel? _populateDoc(DocumentSnapshot value) {
    return MemberDashboardModel.fromEntity(value.id, MemberDashboardEntity.fromMap(value.data() as Map<String, dynamic>));
  }

  Future<MemberDashboardModel?> _populateDocPlus(DocumentSnapshot value) async {
    return MemberDashboardModel.fromEntityPlus(value.id, MemberDashboardEntity.fromMap(value.data() as Map<String, dynamic>), appId: appId);  }
...
//    In the meantime:
      stream = getQuery(appRepository()!.getSubCollection(appId, 'memberdashboard'), orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots().map((data) {
      Iterable<MemberDashboardModel?> memberDashboards  = data.docs.map((doc) {
        MemberDashboardModel? value = _populateDoc(doc);
        return value;
      }).toList();
      return memberDashboards as List<MemberDashboardModel?>;
    });
...
//  see comment listen(...) above
    stream = getQuery(appRepository()!.getSubCollection(appId, 'memberdashboard'), orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots()
        .asyncMap((data) async {
  ...
  Stream<List<MemberDashboardModel?>> values({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) {
    ...
    Stream<List<MemberDashboardModel?>> _values = getQuery(MemberDashboardCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots().map((snapshot) {
  ...
  Stream<List<MemberDashboardModel?>> valuesWithDetails({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) {
    DocumentSnapshot? lastDoc;
    Stream<List<MemberDashboardModel?>> _values = getQuery(MemberDashboardCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots().asyncMap((snapshot) {
  ...
  Future<List<MemberDashboardModel?>> valuesList({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) async {
    DocumentSnapshot? lastDoc;
    List<MemberDashboardModel?> _values = await getQuery(MemberDashboardCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.get().then((value) {
      var list = value.docs;
      return list.map((doc) { 
        lastDoc = doc;
        return _populateDoc(doc);
