...
typedef MemberDashboardChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint:
                          text(widget.app, context, 'Select a memberDashboard'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'memberDashboards', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<MemberDashboardListBloc>(context)
        .add(MemberDashboardChangeQuery(
