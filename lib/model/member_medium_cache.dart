...
class MemberMediumCache implements MemberMediumRepository {
  final MemberMediumRepository reference;
  final Map<String?, MemberMediumModel?> fullCache = {};

  MemberMediumCache(this.reference);

  /// Add a MemberMediumModel to the repository, cached
  @override
  ...
  /// Add a MemberMediumEntity to the repository, cached
  @override
  ...
  /// Update a MemberMediumEntity in the repository, cached
  @override
  ...
  /// Delete a MemberMediumModel from the repository, cached
  @override
  ...
  /// Retrieve a MemberMediumModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<MemberMediumModel?>
  @override
  ...
  static Future<MemberMediumModel> refreshRelations(
      MemberMediumModel model) async {
