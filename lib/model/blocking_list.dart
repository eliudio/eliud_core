...
typedef BlockingWidgetProvider = Function(BlockingModel? value);

class BlockingListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final BlockingWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final BlockingListWidgetState? state;
  ...
  BlockingListWidgetState createState() {
    return BlockingListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = BlockingListWidgetState();
