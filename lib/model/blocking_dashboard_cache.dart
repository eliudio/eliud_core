...
class BlockingDashboardCache implements BlockingDashboardRepository {
  ...
  final Map<String?, BlockingDashboardModel?> fullCache = Map();
  ...
  @override
  Future<BlockingDashboardEntity?> getEntity(String? id, {Function(Exception p1)? onError}) {
  ...
  @override
  StreamSubscription<List<BlockingDashboardModel?>> listen(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<List<BlockingDashboardModel?>> listenWithDetails(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
  ...
  static Future<BlockingDashboardModel> refreshRelations(BlockingDashboardModel model) async {
