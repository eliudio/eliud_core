...
typedef DrawerChanged(String? value, int? privilegeLevel,);
...
class DrawerDropdownButtonWidget extends StatefulWidget {
  ...
  DrawerDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DrawerDropdownButtonWidgetState();
  }
}

class DrawerDropdownButtonWidgetState extends State<DrawerDropdownButtonWidget> {
  DrawerListBloc? bloc;

  DrawerDropdownButtonWidgetState();
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: DropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a drawer'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'drawers', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<DrawerListBloc>(context).add(DrawerChangeQuery(
