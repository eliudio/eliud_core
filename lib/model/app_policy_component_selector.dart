...
class AppPolicyComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<AppPolicyListBloc>(
          ...
          appPolicyRepository:
              appPolicyRepository(appId: appId)!,
          )..add(LoadAppPolicyList()),
      child: SelectAppPolicyWidget(app: app,
          height: height,
...
class SelectAppPolicyWidget extends StatefulWidget {
  ...
  @override
  _SelectAppPolicyWidgetState createState() {
    return _SelectAppPolicyWidgetState();
  }
}

class _SelectAppPolicyWidgetState extends State<SelectAppPolicyWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<AppPolicyListBloc>(context).add(
            AppPolicyChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
