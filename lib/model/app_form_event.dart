...
class ChangedAppAppBars extends AppFormEvent {
  final List<AppBarModel> value;

  ChangedAppAppBars({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppAppBars{ value: $value }';
}

class ChangedAppBackground extends AppFormEvent {
  final List<BackgroundModel> value;

  ChangedAppBackground({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppBackground{ value: $value }';
}

class ChangedAppDialogs extends AppFormEvent {
  final List<DialogModel> value;

  ChangedAppDialogs({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppDialogs{ value: $value }';
}

class ChangedAppDrawer extends AppFormEvent {
  final List<DrawerModel> value;

  ChangedAppDrawer({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppDrawer{ value: $value }';
}

class ChangedAppFont extends AppFormEvent {
  final List<FontModel> value;

  ChangedAppFont({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppFont{ value: $value }';
}

class ChangedAppGridviews extends AppFormEvent {
  final List<GridViewModel> value;

  ChangedAppGridviews({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppGridviews{ value: $value }';
}

class ChangedAppHomemenus extends AppFormEvent {
  final List<HomeMenuModel> value;

  ChangedAppHomemenus({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppHomemenus{ value: $value }';
}

class ChangedAppImages extends AppFormEvent {
  final List<ImageModel> value;

  ChangedAppImages({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppImages{ value: $value }';
}

class ChangedAppMenudefs extends AppFormEvent {
  final List<MenuDefModel> value;

  ChangedAppMenudefs({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppMenudefs{ value: $value }';
}

class ChangedAppPages extends AppFormEvent {
  final List<PageModel> value;

  ChangedAppPages({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppPages{ value: $value }';
}

class ChangedAppPosSizes extends AppFormEvent {
  final List<PosSizeModel> value;

  ChangedAppPosSizes({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppPosSizes{ value: $value }';
}

class ChangedAppShadows extends AppFormEvent {
  final List<ShadowModel> value;

  ChangedAppShadows({this.value});

  @override
  List<Object> get props => [ value ];

  @override
  String toString() => 'ChangedAppShadows{ value: $value }';
}
