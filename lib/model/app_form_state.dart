...
class AccessAppFormError extends AppFormError { 
  const AccessAppFormError({ String message, AppModel value }): super(message: message, value: value);
