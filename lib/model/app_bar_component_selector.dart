...
class AppBarComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<AppBarListBloc>(
      ...
      child: SelectAppBarWidget(app: app,
          height: height,
...
class SelectAppBarWidget extends StatefulWidget {
  ...
  @override
  _SelectAppBarWidgetState createState() {
    return _SelectAppBarWidgetState();
  }
}

class _SelectAppBarWidgetState extends State<SelectAppBarWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<AppBarListBloc>(context).add(
            AppBarChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
