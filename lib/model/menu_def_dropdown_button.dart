...
typedef MenuDefChanged(String? value, int? privilegeLevel,);
...
class MenuDefDropdownButtonWidget extends StatefulWidget {
  ...
  MenuDefDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return MenuDefDropdownButtonWidgetState();
  }
}

class MenuDefDropdownButtonWidgetState extends State<MenuDefDropdownButtonWidget> {
  MenuDefListBloc? bloc;

  MenuDefDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<MenuDefListBloc>(context);
...
return widgets;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MenuDefListBloc, MenuDefListState>(builder: (context, state) {
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a menuDef'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'menuDefs', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<MenuDefListBloc>(context).add(MenuDefChangeQuery(
