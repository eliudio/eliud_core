    ...
    if (currentState is EliudStyleAttributesFormUninitialized) {
      if (event is InitialiseNewEliudStyleAttributesFormEvent) {
        EliudStyleAttributesFormLoaded loaded = EliudStyleAttributesFormLoaded(value: EliudStyleAttributesModel(
                                 ...
                                 appBarTextColor: RgbModel(r: 255, g: 255, b: 255, opacity: 1.00), 
      ...
      if (event is ChangedEliudStyleAttributesFormBackground) {
        if (event.value != null)
          ...
          newValue = new EliudStyleAttributesModel(
                                 ...
                                 appBarBackground: currentState.value!.appBarBackground,
                                 appBarTextColor: currentState.value!.appBarTextColor,
      ...
      if (event is ChangedEliudStyleAttributesAppBarBackground) {
        if (event.value != null)
          newValue = currentState.value!.copyWith(appBarBackground: await backgroundRepository(appId: appId)!.get(event.value));
        else
          newValue = new EliudStyleAttributesModel(
                                 documentID: currentState.value!.documentID,
                                 description: currentState.value!.description,
      ...
      if (event is ChangedEliudStyleAttributesAppBarTextColor) {
        newValue = currentState.value!.copyWith(appBarTextColor: event.value);
        yield SubmittableEliudStyleAttributesForm(value: newValue);
