...
typedef MemberMediumContainerChanged(String? value, int? privilegeLevel,);
...
class MemberMediumContainerDropdownButtonWidget extends StatefulWidget {
  ...
  MemberMediumContainerDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a memberMediumContainer'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'memberMediumContainers', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<MemberMediumContainerListBloc>(context).add(MemberMediumContainerChangeQuery(
