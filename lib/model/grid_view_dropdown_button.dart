...
typedef GridViewChanged(String? value, int? privilegeLevel,);
...
class GridViewDropdownButtonWidget extends StatefulWidget {
  ...
  GridViewDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GridViewDropdownButtonWidgetState();
  }
}

class GridViewDropdownButtonWidgetState extends State<GridViewDropdownButtonWidget> {
  GridViewListBloc? bloc;

  GridViewDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<GridViewListBloc>(context);
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a gridView'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'gridViews', widget.value, (newValue, _) {
                  setState(() {
