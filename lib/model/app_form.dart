...
import 'app_form_bloc.dart';
import 'app_form_event.dart';
    ...
    if (formAction == FormAction.ShowData) {
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update App", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(GlobalData.app().formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add App", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(GlobalData.app().formAppBarBackground)),
                ),
...
class _MyAppFormState extends State<MyAppForm> {
      ...
      if (state is AppFormInitialized) {
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor)),
                  ...
                  decoration: InputDecoration(
                    enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),                    focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: RgbHelper.color(rgbo: GlobalData.app().formFieldFocusColor))),                    icon: Icon(Icons.email, color: RgbHelper.color(rgbo: GlobalData.app().formFieldHeaderColor)),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    title: Text("Dark", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("Dark", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
        ...
        children.add(
                ...
                DropdownButtonComponentFactory().createNew(id: "images", value: _logo, trigger: _onLogoSelected, optional: true),
          );
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    title: Text("SlideRightToLeft", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("SlideRightToLeft", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _routeBuilderSelectedRadioTile,
                    title: Text("SlideBottomToTop", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("SlideBottomToTop", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionRouteBuilder(val);
                    },
                ),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _routeBuilderSelectedRadioTile,
                    title: Text("ScaleRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("ScaleRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionRouteBuilder(val);
                    },
                ),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _routeBuilderSelectedRadioTile,
                    title: Text("RotationRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("RotationRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionRouteBuilder(val);
                    },
                ),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _routeBuilderSelectedRadioTile,
                    title: Text("FadeRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("FadeRoute", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionRouteBuilder(val);
                    },
                ),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    title: Text("Live", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("Live", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _appStatusSelectedRadioTile,
                    title: Text("Offline", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("Offline", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionAppStatus(val);
                    },
                ),
        ...
        children.add(
                ...
                RadioListTile(
                    ...
                    activeColor: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor),
                    groupValue: _appStatusSelectedRadioTile,
                    title: Text("Invisible", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    subtitle: Text("Invisible", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formFieldTextColor))),
                    onChanged: !GlobalData.memberIsOwner() ? null : (val) {
                      setSelectionAppStatus(val);
                    },
                ),
  ...
  bool _readOnly(AppFormInitialized state) {
