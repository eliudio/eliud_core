...
typedef MemberDashboardWidgetProvider = Function(MemberDashboardModel? value);

class MemberDashboardListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final MemberDashboardWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final MemberDashboardListWidgetState? state;
  final bool? isEmbedded;

  MemberDashboardListWidget(
      {super.key,
      required this.app,
      this.readOnly,
      this.form,
  ...
  MemberDashboardListWidgetState createState() {
    return MemberDashboardListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = MemberDashboardListWidgetState();
              ...
              children.add(StyleRegistry.registry()
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    pageRouteBuilder(widget.app,
                        page: BlocProvider.value(
                            value: BlocProvider.of<MemberDashboardListBloc>(
                                context),
                            child: MemberDashboardForm(
                                app: widget.app,
                                value: null,
