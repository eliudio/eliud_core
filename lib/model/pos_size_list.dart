...
typedef PosSizeWidgetProvider(PosSizeModel? value);

class PosSizeListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  PosSizeWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  PosSizeListWidgetState? state;
  bool? isEmbedded;

  PosSizeListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: PosSizeForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return PosSizeListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return PosSizeForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
