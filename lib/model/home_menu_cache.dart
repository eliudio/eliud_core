...
class HomeMenuCache implements HomeMenuRepository {
  ...
  @override
  StreamSubscription<List<HomeMenuModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<HomeMenuModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
