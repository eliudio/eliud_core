...
typedef BlockingChanged(String? value, int? privilegeLevel,);
...
class BlockingDropdownButtonWidget extends StatefulWidget {
  ...
  BlockingDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return BlockingDropdownButtonWidgetState();
  }
}

class BlockingDropdownButtonWidgetState extends State<BlockingDropdownButtonWidget> {
  BlockingListBloc? bloc;

  BlockingDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'blockings', widget.value, (newValue, _) {
                  setState(() {
