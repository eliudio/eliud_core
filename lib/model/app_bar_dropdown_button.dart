...
typedef AppBarChanged(String? value, int? privilegeLevel,);
...
class AppBarDropdownButtonWidget extends StatefulWidget {
  ...
  AppBarDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return AppBarDropdownButtonWidgetState();
  }
}

class AppBarDropdownButtonWidgetState extends State<AppBarDropdownButtonWidget> {
  AppBarListBloc? bloc;

  AppBarDropdownButtonWidgetState();
...
List<Widget> widgets(AppBarModel value) {
var app = widget.app;
var widgets = <Widget>[];
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'appBars', widget.value, (newValue, _) {
                  setState(() {
