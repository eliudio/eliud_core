...
typedef PageWidgetProvider = Function(PageModel? value);

class PageListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final PageWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final PageListWidgetState? state;
  ...
  PageListWidgetState createState() {
    return PageListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = PageListWidgetState();
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AccessBloc, AccessState>(
      ...
      if (accessState is AccessDetermined) {
        return BlocBuilder<PageListBloc, PageListState>(
