...
typedef PageWidgetProvider(PageModel? value);

class PageListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  PageWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  PageListWidgetState? state;
  bool? isEmbedded;

  PageListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return PageListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return PageForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
