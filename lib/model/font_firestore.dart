...
class FontFirestore implements FontRepository {
  ...
  StreamSubscription<FontModel> listenTo(String documentId, FontChanged changed) {
    var stream = FontCollection.document(documentId)
        .snapshots()
        .asyncMap((data) {
  ...
  Future<List<FontModel>> valuesList({String currentMember, String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) async {
    DocumentSnapshot lastDoc;
    List<FontModel> _values = await getQuery(FontCollection, currentMember: currentMember, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).getDocuments().then((value) {
