...
class MemberDashboardCache implements MemberDashboardRepository {
  ...
  /// Add a MemberDashboardModel to the repository, cached
  @override
  ...
  /// Add a MemberDashboardEntity to the repository, cached
  @override
  ...
  /// Update a MemberDashboardEntity in the repository, cached
  @override
  ...
  /// Delete a MemberDashboardModel from the repository, cached
  @override
  ...
  /// Retrieve a MemberDashboardModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<MemberDashboardModel?>
  @override
  ...
  @override
  StreamSubscription<List<MemberDashboardModel?>> listen(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  @override
  StreamSubscription<List<MemberDashboardModel?>> listenWithDetails(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  static Future<MemberDashboardModel> refreshRelations(
      MemberDashboardModel model) async {
