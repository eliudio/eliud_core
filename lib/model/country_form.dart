...
import 'country_form_bloc.dart';
import 'country_form_event.dart';
import 'country_form_state.dart';
  ...
  Widget build(BuildContext context) {
    if (formAction == FormAction.ShowData) {
      return BlocProvider<CountryFormBloc >(
            create: (context) => CountryFormBloc(
                                       formAction: formAction,
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update Country", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(GlobalData.app().formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add Country", style: TextStyle(color: RgbHelper.color(rgbo: GlobalData.app().formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(GlobalData.app().formAppBarBackground)),
                ),
...
class _MyCountryFormState extends State<MyCountryForm> {
  ...
  bool _readOnly(CountryFormInitialized state) {
