...
class PosSizeCache implements PosSizeRepository {
  ...
  @override
  StreamSubscription<List<PosSizeModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<PosSizeModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
