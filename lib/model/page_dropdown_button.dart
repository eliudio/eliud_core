...
typedef PageChanged(String? value, int? privilegeLevel,);
...
class PageDropdownButtonWidget extends StatefulWidget {
  ...
  PageDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: DropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a page'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'pages', widget.value, (newValue, _) {
                  setState(() {
