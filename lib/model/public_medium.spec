{
  ...
  "fields": [
    ...
    },
    {
      ...
      "fieldType": "String",
      "refCode": "referencesCollector.addAll(await mediumCollectReferences(appId: appId, relatedMediumId: relatedMediumId, repo: publicMediumRepository(appId: appId)!, packageName: packageName, id: id));"
    }
  ],
  "groups": [
    {
