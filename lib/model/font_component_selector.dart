...
class FontComponentSelector extends ComponentSelector {
  @override
  Widget createSelectWidget(BuildContext context, double height,
    ...
    return BlocProvider<FontListBloc>(
          create: (context) => FontListBloc(
            fontRepository:
                fontRepository(appId: AppBloc.currentAppId(context))!,
          )..add(LoadFontList()),
...
class SelectFontWidget extends StatefulWidget {
  ...
  @override
  _SelectFontWidgetState createState() {
    return _SelectFontWidgetState();
  }
}

class _SelectFontWidgetState extends State<SelectFontWidget> {
  Widget theList(BuildContext context, List<FontModel?> values) {
