...
typedef PosSizeChanged(String? value);

class PosSizeDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final String? value;
  final PosSizeChanged? trigger;
  final bool? optional;

  PosSizeDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PosSizeDropdownButtonWidgetState();
  }
}

class PosSizeDropdownButtonWidgetState extends State<PosSizeDropdownButtonWidget> {
  PosSizeListBloc? bloc;

  PosSizeDropdownButtonWidgetState();
...
List<Widget> widgets(PosSizeModel value) {
var app = widget.app;
var widgets = <Widget>[];
