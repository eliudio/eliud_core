...
class GridViewCache implements GridViewRepository {
  ...
  @override
  StreamSubscription<List<GridViewModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<GridViewModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
