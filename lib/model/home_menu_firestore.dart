...
/* 
 * HomeMenuFirestore is the firestore implementation of HomeMenuRepository
 */
class HomeMenuFirestore implements HomeMenuRepository {
  ...
  Future<HomeMenuModel?> _populateDoc(DocumentSnapshot value) async {
    return HomeMenuModel.fromEntity(
        value.id, HomeMenuEntity.fromMap(value.data()));
  }

  Future<HomeMenuModel?> _populateDocPlus(DocumentSnapshot value) async {
    return HomeMenuModel.fromEntityPlus(
        value.id, HomeMenuEntity.fromMap(value.data()),
        appId: appId);
  }
...
//  stream = getQuery(homeMenuCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots()
  ...
  StreamSubscription<HomeMenuModel?> listenTo(
    ...
    var stream =
        homeMenuCollection.doc(documentId).snapshots().asyncMap((data) {
  ...
  Stream<List<HomeMenuModel?>> values(
    ...
    Stream<List<HomeMenuModel?>> values = getQuery(homeMenuCollection,
            orderBy: orderBy,
            descending: descending,
            startAfter: startAfter as DocumentSnapshot?,
            limit: limit,
  ...
  Future<List<HomeMenuModel?>> valuesList(
    ...
    DocumentSnapshot? lastDoc;
    List<HomeMenuModel?> values = await getQuery(homeMenuCollection,
            orderBy: orderBy,
            descending: descending,
            startAfter: startAfter as DocumentSnapshot?,
            limit: limit,
  ...
  final String appId;
  HomeMenuFirestore(this.getCollection, this.appId)
      : homeMenuCollection = getCollection();
