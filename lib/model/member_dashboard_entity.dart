...
class MemberDashboardEntity implements EntityBase {
  ...
  static MemberDashboardEntity? fromMap(Object? o, {Map<String, String>? newDocumentIds}) {
  ...
  static MemberDashboardEntity? fromJsonString(String json, {Map<String, String>? newDocumentIds}) {
