...
class ShadowCache implements ShadowRepository {
  ...
  @override
  StreamSubscription<List<ShadowModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<ShadowModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
