...
class MemberCache implements MemberRepository {
  ...
  final Map<String?, MemberModel?> fullCache = {};

  MemberCache(this.reference);

  /// Add a MemberModel to the repository, cached
  @override
  ...
  /// Retrieve a MemberModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<MemberModel?>
  @override
