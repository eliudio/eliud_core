...
typedef DecorationColorWidgetProvider = Function(DecorationColorModel? value);

class DecorationColorListWidget extends StatefulWidget with HasFab {
  final AppModel app;
  final BackgroundModel? listBackground;
  final DecorationColorWidgetProvider? widgetProvider;
  final bool? readOnly;
  final String? form;
  //final DecorationColorListWidgetState? state;
  ...
  DecorationColorListWidgetState createState() {
    return DecorationColorListWidgetState();
  }

  @override
  Widget? fab(BuildContext context) {
    if ((readOnly != null) && readOnly!) return null;
    var state = DecorationColorListWidgetState();
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AccessBloc, AccessState>(
      ...
      if (accessState is AccessDetermined) {
        return BlocBuilder<DecorationColorListBloc, DecorationColorListState>(
              ...
              children.add(StyleRegistry.registry()
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    pageRouteBuilder(widget.app,
                        page: BlocProvider.value(
                            value: BlocProvider.of<DecorationColorListBloc>(
                                context),
                            child: DecorationColorForm(
                                app: widget.app,
                                value: null,
