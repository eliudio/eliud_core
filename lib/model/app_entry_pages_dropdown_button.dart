...
typedef AppEntryPagesChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _AppEntryPagesDropdownButtonWidgetState
  ...
  List<Widget> _widgets(AppEntryPagesModel value) {
    ...
    widgets.add(value.entryPage!.title != null
        ? Center(
            child: StyleRegistry.registry()
                .styleWithApp(app)
                .frontEndStyle()
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      items: items,
                      value: value,
                      hint: text(widget.app, context, 'Select a appEntryPages'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'appEntryPagess', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
