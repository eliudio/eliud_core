...
class BackgroundCache implements BackgroundRepository {
  ...
  @override
  StreamSubscription<List<BackgroundModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<BackgroundModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
