...
class BorderRadiusEntity implements EntityBase {
  ...
  static BorderRadiusEntity? fromMap(Object? o, {Map<String, String>? newDocumentIds}) {
  ...
  static BorderRadiusEntity? fromJsonString(String json, {Map<String, String>? newDocumentIds}) {
