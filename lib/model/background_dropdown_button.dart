...
typedef BackgroundChanged(String? value);

class BackgroundDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final String? value;
  final BackgroundChanged? trigger;
  final bool? optional;

  BackgroundDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return BackgroundDropdownButtonWidgetState();
  }
}

class BackgroundDropdownButtonWidgetState extends State<BackgroundDropdownButtonWidget> {
  BackgroundListBloc? bloc;

  BackgroundDropdownButtonWidgetState();
