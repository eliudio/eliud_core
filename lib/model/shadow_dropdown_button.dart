...
class ShadowDropdownButtonWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ShadowDropdownButtonWidgetState();
  }
}

class ShadowDropdownButtonWidgetState extends State<ShadowDropdownButtonWidget> {
  ShadowListBloc? bloc;

  ShadowDropdownButtonWidgetState();
...
List<Widget> widgets(ShadowModel pm) {
