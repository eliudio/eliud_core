...
typedef MemberPublicInfoChanged(String? value, int? privilegeLevel,);
...
class MemberPublicInfoDropdownButtonWidget extends StatefulWidget {
  ...
  MemberPublicInfoDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
class MemberPublicInfoDropdownButtonWidgetState extends State<MemberPublicInfoDropdownButtonWidget> {
...
List<Widget> widgets(MemberPublicInfoModel value) {
var app = widget.app;
var widgets = <Widget>[];
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a memberPublicInfo'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'memberPublicInfos', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<MemberPublicInfoListBloc>(context).add(MemberPublicInfoChangeQuery(
