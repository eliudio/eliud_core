...
class MemberClaimCache implements MemberClaimRepository {
  final MemberClaimRepository reference;
  final Map<String?, MemberClaimModel?> fullCache = {};

  MemberClaimCache(this.reference);

  /// Add a MemberClaimModel to the repository, cached
  @override
  ...
  /// Add a MemberClaimEntity to the repository, cached
  @override
  ...
  /// Update a MemberClaimEntity in the repository, cached
  @override
  ...
  /// Delete a MemberClaimModel from the repository, cached
  @override
  ...
  /// Retrieve a MemberClaimModel with it's id, cached
  @override
  ...
  /// Retrieve list of List<MemberClaimModel?>
  @override
  ...
  @override
  StreamSubscription<List<MemberClaimModel?>> listen(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  @override
  StreamSubscription<List<MemberClaimModel?>> listenWithDetails(trigger,
      {String? orderBy,
      bool? descending,
      Object? startAfter,
      int? limit,
  ...
  static Future<MemberClaimModel> refreshRelations(
      MemberClaimModel model) async {
