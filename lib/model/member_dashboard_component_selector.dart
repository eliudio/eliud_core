...
import 'member_dashboard_list_bloc.dart';
import 'member_dashboard_list_event.dart';
...
class SelectMemberDashboardWidget extends StatefulWidget {
  ...
  @override
  _SelectMemberDashboardWidgetState createState() {
    return _SelectMemberDashboardWidgetState();
  }
}

class _SelectMemberDashboardWidgetState extends State<SelectMemberDashboardWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<MemberDashboardListBloc>(context).add(
            MemberDashboardChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MemberDashboardListBloc, MemberDashboardListState>(
      ...
      if ((state is MemberDashboardListLoaded) && (state.values != null)) {
