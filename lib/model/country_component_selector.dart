...
class SelectCountryWidget extends StatefulWidget {
  ...
  @override
  _SelectCountryWidgetState createState() {
    return _SelectCountryWidgetState();
  }
}

class _SelectCountryWidgetState extends State<SelectCountryWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<CountryListBloc>(context).add(
            CountryChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CountryListBloc, CountryListState>(
      ...
      if ((state is CountryListLoaded) && (state.values != null)) {
