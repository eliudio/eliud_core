...
import 'member_public_info_list_bloc.dart';
import 'member_public_info_list_event.dart';
...
class MemberPublicInfoComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<MemberPublicInfoListBloc>(
      ...
      child: SelectMemberPublicInfoWidget(app: app,
          height: height,
...
class SelectMemberPublicInfoWidget extends StatefulWidget {
  ...
  @override
  _SelectMemberPublicInfoWidgetState createState() {
    return _SelectMemberPublicInfoWidgetState();
  }
}

class _SelectMemberPublicInfoWidgetState extends State<SelectMemberPublicInfoWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<MemberPublicInfoListBloc>(context).add(
            MemberPublicInfoChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }

  Widget theList(BuildContext context, List<MemberPublicInfoModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MemberPublicInfoListBloc, MemberPublicInfoListState>(
      ...
      if ((state is MemberPublicInfoListLoaded) && (state.values != null)) {
